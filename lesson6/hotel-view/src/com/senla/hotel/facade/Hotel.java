...
public class Hotel {
    ...
    public boolean sortClientCapabilitiesByPrice(int clientId) {
        try {
            Client client = clientService.getClient(clientId);
            if (client != null) {
                capabilityService.sortCapabilities(client.getCapabilities(), new com.senla.hotel.comparators.capabilities.PriceComparator());
                return true;
            } else {
                return false;
            }
    ...
    public boolean sortAllCapabilitiesByPrice() {
        try {
            capabilityService.sortCapabilities(new com.senla.hotel.comparators.capabilities.PriceComparator());
            return true;
        } catch (Exception e) {
            logger.error("Sort by price error!");
            return false;
